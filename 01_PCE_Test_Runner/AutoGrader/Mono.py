...
# *Sigh*  I'm running this under cygwin, but need to mash the paths to make this work with the csc
# command-line parameters (/out looks like a dir on *nix, and /cygwin/e/etc looks like a param
# to CSC.
	if(USING_CSC):
...
#	print "Command to compile "+whatIsThis+"\n" + CMD_LINE
	...
	print whatIsThis + " code compiled successfully"
	return COMPILER_OK
...
#	sys.exit(0)
	...
	REF_PREFIX = SOLUTION_PREFIX + "DELETE_THIS_and_bin_and_obj_folders/"
